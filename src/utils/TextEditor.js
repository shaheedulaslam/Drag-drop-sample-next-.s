 ...
 export const TextEditor = () => {
    ...
    return (
      <div>
        ...
        <textarea value={text} rows={7} onChange={handleTextChange} className="border my-8"/>
  ...
  export const HeadingEditor = () => {
    ...
    return (
        ...
        <div>
                <input type="text" value={headingText} onChange={handleTextChange} placeholder="Heading Text" className="border" />
            </div>
            </div>
            <h1 style={headingStyle} className="text-black">{headingText}</h1>
            </>
    );
  };
