  ...
  return (
    <>
      {children?.map((item, index) => (
        <>
        <div
            className="grid grid-cols-1 p-3 w-full"
            onDrop={handleDrop}
          ...
          >
            <div>
                ...
                key={index}
                id={item?.sectionId}
                className="flex relative rounded h-80 bg-white p-1"
              >
                <button
...
export function Section2({ onDrop, children, onDeleteItem }) {
  ...
  return (
    <>
      <div
        className="grid grid-cols-2 my-1 p-3 space-x-1"
        onDrop={handleDrop}
        onDragOver={(e) => e.preventDefault()}
      >
          ...
          {children?.map((item, index) => (
            <>
              ...
              <div
                key={index}
                id={item?.sectionId}
                className="flex relative rounded h-72 bg-white p-2"
              >
                <button
                  onClick={() => handleSaveEdit(index)}
                  className="absolute top-0 right-7"
...
export function Section3({ onDrop, children, onDeleteItem }) {
  ...
  return (
    <>
      <div
        className="grid grid-cols-3 p-3 space-x-1"
        onDrop={handleDrop}
        onDragOver={(e) => e.preventDefault()}
      >
...
export function Section4({ onDrop, children, onDeleteItem }) {
  ...
  return (
    <>
      <div
        className="grid grid-cols-4 p-3 space-x-1"
        onDrop={handleDrop}
        onDragOver={(e) => e.preventDefault()}
      >
